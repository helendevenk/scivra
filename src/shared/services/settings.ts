...
export async function getSettingGroups() {
  ...
  const settingGroups: SettingGroup[] = [
    ...
    {
      name: 'microsoft_auth',
      title: t('groups.microsoft_auth'),
      description: 'custom your microsoft auth settings',
      tab: 'auth',
    },
    {
      name: 'apple_auth',
      title: t('groups.apple_auth'),
      description: 'custom your apple auth settings',
      tab: 'auth',
    },
    {
      name: 'basic_payment',
    ...
    },
    {
      ...
      description:
        'custom your <a href="https://affonso.io?atp=scivra" class="text-primary" target="_blank">Affonso</a> settings',
      tab: 'affiliate',
    },
    {
      name: 'promotekit',
      ...
      description:
        'custom your <a href="https://www.promotekit.com?via=scivra" class="text-primary" target="_blank">PromoteKit</a> settings',
      tab: 'affiliate',
    },
    {
      name: 'crisp',
...
export async function getSettings() {
  const settings: Setting[] = [
    ...
    },
    {
      ...
      placeholder:
        'Scivra is an interactive 3D physics simulation platform for education.',
      type: 'textarea',
      group: 'appinfo',
      tab: 'general',
    },
    ...
    },
    {
      ...
      title: 'Tenant ID',
      type: 'text',
      placeholder: 'common (multi-tenant) or your tenant ID',
      tip: 'Use "common" to allow any Microsoft account, or enter your Azure AD tenant ID for single-tenant apps',
      group: 'microsoft_auth',
      tab: 'auth',
    },
    {
    ...
    },
    {
      ...
      tip: 'The Services ID from Apple Developer Console (e.g. com.yourapp.web)',
      group: 'apple_auth',
      tab: 'auth',
    },
    {
      name: 'apple_client_secret',
      title: 'Apple Client Secret (JWT)',
      type: 'password',
      placeholder: '',
      tip: 'A JWT signed with your Apple private key. Valid up to 6 months. Generate with: team_id, key_id, private_key (.p8 file)',
      group: 'apple_auth',
      tab: 'auth',
    },
    {

...
export async function getSettings() {
  ...
  "premium-yearly": "promo_xxx"
    ...
    },
    {
      ...
      tip: 'Controls who can start a new Stripe checkout. Use Smoke during live-mode cutover to limit access to specific testers (see Smoke Allowlist below).',
      group: 'stripe',
      tab: 'payment',
    },
    {
      name: 'stripe_smoke_user_emails',
      title: 'Stripe Smoke Allowlist',
      type: 'textarea',
      placeholder: 'helendevenk@gmail.com',
      attributes: { rows: 3 },
      tip: 'Comma- or newline-separated email list. Only these users can checkout when stripe_checkout_mode = smoke.',
      group: 'stripe',
      tab: 'payment',
    },
    {

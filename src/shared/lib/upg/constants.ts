...
export const UPG_DEFAULT_MODEL =
  process.env.UPG_MODEL || process.env.OPUS_MODEL || 'claude-sonnet-4-6';
export const UPG_FALLBACK_MODEL =
  process.env.UPG_FALLBACK_MODEL || UPG_DEFAULT_MODEL;
export const UPG_MAX_GENERATION_TIME_MS = 300000; // 5 min for Sonnet
export const UPG_CREDITS_PER_GENERATION = 200;
export const UPG_CREDITS_PER_REGENERATION = 200;
...
export const UPG_CREDITS_PER_REFINEMENT = 200;

...
export const rutherfordScattering: Experiment = {
  ...
  contentSections: {
    whatIsIt:
      "In 1909, two of Rutherford's students, Geiger and Marsden, did one of the most surprising experiments in the history of physics. They fired alpha particles — fast, heavy, positively charged helium nuclei — at a thin sheet of gold foil, expecting them to plow straight through like bullets through paper. Most did. But every now and then one bounced almost straight back. Rutherford famously said it was 'as if you fired a 15-inch shell at tissue paper and it came back and hit you.' That backscattering killed the popular 'plum pudding' model (positive charge smeared evenly through the atom) and gave birth to the nuclear atom: nearly all the mass and all the positive charge crammed into a tiny core, with electrons spread far around it. This simulation lets you reproduce that experiment, aim alpha particles at any nucleus from hydrogen (Z=1) to fermium (Z=100), and watch Coulomb repulsion sling them off at angles set by how close they pass to the nucleus.",

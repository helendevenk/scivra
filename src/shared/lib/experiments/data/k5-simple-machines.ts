...
export const k5SimpleMachines: Experiment = {
  ...
  contentSections: {
    ...
    teacherUseCases: [
      ...
      "Ramp vs. lifting comparison: switch machineType to 2 (Inclined Plane) and use effortArm to model ramp length effects. Students predict and record how the required push force changes as the effort arm increases or decreases, connecting to NGSS 3-PS2-1 and 4-PS3-4. Note: for the pulley and inclined plane types, effortArm and loadArm model the mechanical advantage inputs; a real inclined plane's length-to-height ratio determines the same trade-off.",

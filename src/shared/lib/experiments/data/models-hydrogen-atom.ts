...
export const modelsHydrogenAtom: Experiment = {
  ...
  contentSections: {
    ...
    teacherUseCases: [
      ...
      "Rydberg verification table: have students measure and record the absorption wavelength for transitions n=1→2, 1→3, 1→4 and 2→3, 2→4, 2→5, then plot 1/λ versus (1/n₁² − 1/n₂²) and extract the Rydberg constant from the slope. This is one of the cleanest places in AP Physics 2 to do real data-driven prediction.",

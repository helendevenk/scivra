...
export const msAcidBaseReactions: Experiment = {
  ...
  contentSections: {
    ...
    parameterExplanations: {
      acidType:
        "Selects the acid used in the reaction (0=Hydrochloric, 1=Vinegar, 2=Citric, 3=Sulfuric). Hydrochloric acid (HCl, option 0) and sulfuric acid (H2SO4, option 3) are strong acids — they release all of their hydrogen ions in water, making them highly reactive even at low concentrations. Vinegar (acetic acid, option 1) and citric acid (option 2) are weak acids — they only partially release H+ ions, so they reach the same pH change more slowly and the temperature rise during neutralization is gentler.",
      baseType:
        "Selects the base used in the reaction (0=Sodium Hydroxide, 1=Baking Soda, 2=Ammonia, 3=Calcium Hydroxide). Sodium hydroxide (NaOH, option 0) and calcium hydroxide (option 3) are strong bases that fully release OH- ions. Baking soda (sodium bicarbonate, option 1) and ammonia (option 2) are weak bases that only partially ionize. Pairing a strong acid with a strong base produces the most vigorous and complete neutralization, while mixing weak acid and weak base produces a more gradual reaction.",
      concentration:
    ...
    teacherUseCases: [
      ...
      "Real-world neutralization connection: use acidType 2 (Citric) and baseType 1 (Baking Soda) — the same reaction as fizzing antacid tablets in stomach acid. Students observe the pH shift and discuss how antacids relieve heartburn through neutralization, then calculate how many H+ ions are being removed as pH rises from 2 to 6.",
    ...
    faq: [
      {
        ...
        answer:
          "pH stands for 'potential of hydrogen' and measures the concentration of hydrogen ions (H+) in a solution. The formula is pH = -log[H+], which means the scale is logarithmic: each whole number step represents a tenfold change. At pH 7, the H+ and OH- concentrations are equal and the solution is neutral. Below pH 7, H+ ions outnumber OH- ions (acidic). Above pH 7, OH- ions dominate (basic). Because of the logarithmic scale, orange juice at pH 4 is 1,000 times more acidic than black coffee at pH 7.",
      },
      {

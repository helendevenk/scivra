...
export const k5MixturesSolutions: Experiment = {
  ...
  contentSections: {
    ...
    teacherUseCases: [
      ...
      "Temperature investigation: fix substanceType at 0 (salt) and compare waterTemp 10°C vs. 60°C. Students time how quickly the salt disappears and record findings in a simple data table.",

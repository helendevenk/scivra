...
export const curveFitting: Experiment = {
  ...
  instructions:
    "Click to add data points or load a preset dataset. Select a fit type and observe how the curve adjusts. Check residual plot for systematic patterns. Higher R² means a better fit, but for nested polynomial least-squares fits on the same data, extra terms cannot decrease training R² — use physical intuition to judge whether improvement is meaningful.",
  challenges: [

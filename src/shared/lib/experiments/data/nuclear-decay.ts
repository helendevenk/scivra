...
export const nuclearDecay: Experiment = {
  ...
  contentSections: {
    whatIsIt:
      "Every living thing on Earth contains a tiny fraction of carbon-14, an unstable isotope made by cosmic rays in the upper atmosphere. While you're alive, you keep replenishing it through the carbon cycle. The moment you stop — when an organism dies, when a tree is cut for a wooden tool, when ancient charcoal forms in a campfire — the carbon-14 starts ticking down. Half of it is gone in 5,730 years, half of what's left is gone 5,730 years after that, and so on. Measure how much remains and you've measured how long ago that thing died. That's radiocarbon dating, and the underlying physics is exactly what this simulation makes visible: spontaneous, random nuclear decay obeying a strict statistical law. Pick a decay mode (alpha, beta-minus, beta-plus, or gamma), set a half-life and an initial sample, and watch the activity curve fall by half each half-life as the daughter nuclide builds up. Same equations also describe radon in basements, medical tracers in PET scans, and the spent fuel in a reactor.",

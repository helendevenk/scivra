...
export const starLifeCycle: Experiment = {
  ...
  contentSections: {
    whatIsIt:
      "Every star you see tonight is mid-story in a process that spans millions to trillions of years. Stars form when a cloud of gas and dust collapses under gravity, heating until hydrogen fusion ignites in the core. That fusion pressure balances gravity and locks the star onto the main sequence of the Hertzsprung-Russell (HR) diagram for roughly 90% of its life. What happens next depends almost entirely on initial mass. Stars below about 0.5 solar masses (M☉) are red dwarfs and will outlast the current age of the universe. Stars like the Sun (0.5–8 M☉) swell into red giants, shed their outer layers as a glowing planetary nebula, and leave a white dwarf behind. Stars above ~8 M☉ explode in a core-collapse supernova, leaving a neutron star or black hole. This simulation traces those paths on a live HR diagram as stellar mass is adjusted from 0.5 to 40 M☉.",
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "HS-ESS1-1 asks students to develop a model based on evidence to illustrate the life span of the Sun and the role of nuclear fusion in the Sun's core. HS-ESS1-3 asks for a model of the role of nuclear fusion in the synthesis of heavy elements in stars. This simulation directly visualizes both: the mass slider shows how initial conditions determine life span, and the end-state outcomes (neutron stars, black holes) connect to nucleosynthesis of elements heavier than iron.",
      },
      {

...
export const k5LightPropagation: Experiment = {
  ...
  contentSections: {
    ...
    parameterExplanations: {
      ...
      refractiveIndex:
        "Light Bending Strength tells how much a clear material changes the path of light. A value near 1 acts more like air, so the beam changes direction only a little. A higher value acts more like glass or a prism, so the beam bends more. Students do not need to calculate with this number in K5. They can treat it as a strength slider for light bending when it goes through different stuff like water and glass. Try the Rainbow (Prism) preset and then move the bending strength up and down. This helps students build a model: light travels to the eye after bouncing, passing through clear materials, or bending at materials, which connects to 4-PS4.",
    },
    misconceptions: [
      {

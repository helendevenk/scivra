...
export const k5Magnetism: Experiment = {
  ...
  contentSections: {
    whatIsIt:
      "Have you ever stuck a magnet to your refrigerator or picked up a paper clip with a magnet? Magnets have an invisible pushing and pulling force called magnetism! Every magnet has two ends called poles — a North pole and a South pole. When you bring two opposite poles near each other (North toward South), they snap together like best friends hugging. When you bring two same poles near each other (North toward North or South toward South), they push away like grumpy strangers who do not want to be close. This is called attraction and repulsion. The invisible force around a magnet is called a magnetic field. You cannot see it with your eyes, but you can feel it — and in this simulation you can see the field lines that show where the force reaches. Not everything sticks to a magnet. Only objects made of iron, steel, nickel, or cobalt feel the pull. Gold, plastic, wood, and aluminum do not care about magnets at all. Earth is actually one giant magnet — that is why compass needles always point roughly toward the North Pole! The Earth's magnetic field protects us from harmful rays from the Sun too.",
    parameterExplanations: {
      magnet1Strength:
        "This slider controls how powerful the first magnet is, from 0.1 T (a weak fridge magnet) up to 2 T (a strong science-lab magnet). A stronger magnet pulls or pushes with much more force and its field reaches farther. Watch the field lines get brighter and more spread out as you increase strength. A real refrigerator magnet is only about 0.005 T — this simulation lets you explore much stronger ones!",
      magnet2Polarity:
      ...
      distance:
        "This slider moves the two magnets closer together or farther apart, from 1 cm (nearly touching) to 20 cm (far apart). Magnetic force gets much weaker very quickly as distance grows. Even moving from 2 cm to 4 cm (doubling the distance) makes the force drop to about one quarter of what it was. Try setting a strong magnet and then sliding the distance from 1 cm to 20 cm to feel how fast the force fades.",
      showEarth:
    ...
    misconceptions: [
      ...
      },
      {
        ...
        correct:
          "They are close but not the same! Geographic North is Earth's rotational axis — the point where all the longitude lines meet. Magnetic North is where Earth's magnetic field points downward, and it is located in northern Canada, several hundred kilometers away from the geographic North Pole. This difference is called magnetic declination, and it slowly changes over time as Earth's liquid iron core moves. Hikers and sailors must account for this difference when navigating with a compass.",
      },
    ],
    teacherUseCases: [

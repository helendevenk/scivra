  ...
  contentSections: {
    ...
    misconceptions: [
      ...
      },
      {
        ...
        correct:
          "Friction is a force that opposes motion, but it decelerates objects gradually rather than stopping them instantly. In the simple kinetic-friction model, friction force = μ × normal force = μmg, so deceleration a = μmg/m = μg — mass cancels, and the deceleration depends only on the friction coefficient, not the object's mass. In the simulation, you can see this as a downward slope on the v-t graph — gradual and consistent regardless of mass for the same friction setting.",
      },
    ],
    teacherUseCases: [

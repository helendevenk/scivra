...
export const k5SoundVibration: Experiment = {
  ...
  contentSections: {
    ...
    teacherUseCases: [
      ...
      "Silence in space: this simulation includes air, water, and steel — it does not include a vacuum setting. Compare all three mediums (0=air, 1=water, 2=steel) and discuss how sound gets faster in denser materials. Then ask: what would happen if there were NO medium at all, like in space? Connect to the NGSS concept that waves need a medium, and explain that real space is completely silent because there are no molecules to carry the vibration.",

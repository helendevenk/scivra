...
export const k5DayNightSeasons: Experiment = {
  ...
  contentSections: {
    ...
    parameterExplanations: {
      earthTilt:
        "This slider changes how much Earth is tilted to one side. Earth usually tilts about 23.5 degrees. When you set the tilt to 0 degrees, the seasons disappear — every place gets the same amount of sunlight all year. Push the tilt higher and the seasons get more extreme — summers get hotter and winters get colder. Try it and see!",
      orbitPosition:
    ...
    faq: [
      {
        ...
        answer:
          "Earth is always spinning like a top. When your side of Earth faces the Sun, you get daylight. As Earth keeps spinning, your side turns away from the Sun and it becomes night. The Sun did not go anywhere — you just spun away from it! After about 12 hours of night, your part of Earth spins back toward the Sun and morning comes again. This spinning is why we see the Sun rise every morning and set every evening. This experiment addresses NGSS standard 1-ESS1-1, which asks students to use observations to describe patterns of the Sun, Moon, and stars in the sky.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "If Earth had no tilt, there would be no seasons! Every place on Earth would have the same weather all year long. The equator would always be warm, and the poles would always be cold, but nothing would change from month to month. We would not have the changes in day length we see through the year either. Many animals and plants depend on seasonal changes to know when to grow, migrate, or hibernate, so life on Earth would look very different. You can try this in the simulation by setting earthTilt to 0 degrees.",
      },
      {

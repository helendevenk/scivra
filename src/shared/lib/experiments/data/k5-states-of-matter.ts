...
export const k5StatesOfMatter: Experiment = {
  ...
  contentSections: {
    ...
    teacherUseCases: [
      ...
      "Set substance to Iron (1) and try to reach its melting point; use this to discuss why we build bridges and frying pans from iron and steel — they stay solid at temperatures we ever encounter in daily life.",

...
export const msAtomsMolecules: Experiment = {
  ...
  contentSections: {
    ...
    parameterExplanations: {
      ...
      electrons:
        "Sets the number of electrons surrounding the nucleus (0 to 18). In a neutral atom, electrons equal protons. If electrons are fewer than protons, the atom has a net positive charge and is called a cation (positive ion). If electrons exceed protons, the atom has a net negative charge and is called an anion (negative ion). Electrons fill shells in order: the first shell holds up to 2, the second up to 8, and in this simplified first-18-elements model the third shell starts filling after the first 10 electrons and holds up to another 8. The outermost electrons — called valence electrons — determine how the atom interacts chemically with other atoms.",
      showBonding:
        "Toggles the molecular bonding visualization (0=off, 1=on; Pro feature). When enabled, valence electrons are highlighted and you can observe how atoms with incomplete outer shells interact with other atoms to share or transfer electrons, forming molecules, ionic compounds, or extended structures. This directly shows why elements in the same group of the periodic table tend to form similar types of bonds.",
    },
    misconceptions: [
      {
    ...
    teacherUseCases: [
      ...
      "Periodic table group patterns: compare atoms in the same group — set protons to 3 (lithium), note 1 valence electron; then protons to 11 (sodium), note 1 valence electron again. Students identify that both Group 1 elements share 1 valence electron and predict similar chemical behavior, building the conceptual foundation for why the periodic table is organized as it is. (Potassium at Z=19 is beyond the simulation's range of 1–18, so it can be discussed as an extension.)",
    ],
    faq: [
      {

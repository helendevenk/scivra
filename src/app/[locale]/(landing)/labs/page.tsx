...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Free Interactive Science Labs | NeonPhysics",
    description:
      "Explore 100+ free interactive virtual science labs covering Physics, Chemistry, Biology, Earth Science, and Math. Aligned with AP, NGSS, and K-12 standards.",
    keywords:
      "virtual labs, science experiments, physics simulations, chemistry labs, biology labs, interactive learning, AP Physics, NGSS",
  };
}

export default async function LabsIndexPage({ params }: Props) {
  const { locale } = await params;
  setRequestLocale(locale);
      ...
      <section className="rounded-2xl border border-primary/10 bg-card p-8 md:p-12">
        ...
        <div className="grid gap-8 md:grid-cols-3">
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-muted-foreground">
              Access 3 full experiments for free. No credit card required. Upgrade
